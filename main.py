...
def main():
    ...
    Imap_EmailChecker_Hotmail = ip_cr.Checker(imap_server="imap.hotmail.com")
        ...
        with open(sys.argv[2], "w") as output_file:
            for email_data in emails_data:
                ...
                if not email_provider in supported_email_providiers:
                    ...
                    if email_provider == "hotmail.de" or email_provider == "hotmail.com":
                        if Imap_EmailChecker_Hotmail.check_credentials(email, password):
                            output_file.write(email_data + " " + "Login erfolgreich.\n")
                        else:
                            output_file.write(email_data + " " + "Login fehlgeschlagen!\n")
